...
- It grants the `Storage Object Viewer`, `Logs Writer`, `Artifact Registry Writer`, `Firestore Admin`, and `Cloud Tasks Admin` roles to the project's **Default Compute Engine service account**.
